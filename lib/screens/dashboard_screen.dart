        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Row(
                children: [
                  Expanded(child: statBox("Profit", "₹150", Colors.green)),

                  const SizedBox(width: 12),

                  Expanded(child: statBox("Bets", "12", Colors.orange)),
                ],
              ),
              ...
              Row(
                children: [
                  Expanded(child: statBox("Wins", "7", Colors.blue)),

                  const SizedBox(width: 12),

                  Expanded(child: statBox("Loss", "5", Colors.red)),
                ],
              ),
